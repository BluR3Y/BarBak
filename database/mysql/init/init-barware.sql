...
CREATE TABLE measure (
    ...
    `measure_use` ENUM('volume', 'mass', 'miscellaneous', 'quantity') NOT NULL,
    `ounce_equivalence` FLOAT,
    PRIMARY KEY(`id`)
);

INSERT INTO measure (`singular_name`, `plural_name`, `abbriviation`, `is_standardized`, `measure_use`, `ounce_equivalence`) VALUES 
    ('ounce', 'ounces', 'oz', 1, 'mass', 1),
    ('fluid ounce', 'fluid ounces', 'fl oz', 1, 'volume', 1),
    ('milliliter', 'milliliters', 'ml', 1, 'volume', 29.5735),
    ('teaspoon', 'teaspoons', 'tsp', 1, 'volume', 6),
    ('tablespoon', 'tablespoons', 'tbsp', 1, 'volume', 2),
    ('pint', 'pints', 'pt', 1, 'volume', 0.0625),
    ('liter', 'liters', 'L', 1, 'volume', 0.0295735),
    ('dash', 'dashes',  NULL, 0, 'volume', NULL),
    ('shot', 'shots',  NULL, 0, 'volume', NULL),
    ('centiliter', 'centiliters', 'cl', 1, 'volume', 2.95735),
    ('cup', 'cups', 'c', 1, 'volume', 0.125),
    ('quart', 'quarts', 'qt', 1, 'volume', 0.03125),
    ('drop', 'drops', NULL, 0, 'volume', NULL),
    ('gram', 'grams', 'gm', 1, 'mass', 28.3495),
    ('milligram', 'milligrams', 'mg', 1, 'mass', 28349.5),
    ('pound', 'pounds', 'lb', 1, 'mass', 0.0625),
    ('splash', 'splashes', NULL, 0, 'volume', NULL),
    ('part', 'parts', NULL, 0, 'miscellaneous', NULL),
    ('half', 'halves', NULL, 0, 'miscellaneous', NULL),
    ('leaf', 'leaves', NULL, 0, 'quantity', NULL),
    ('peel' , 'peels', NULL, 0, 'quantity', NULL),
    ('quarter', 'quarters', NULL, 0, 'miscellaneous', NULL),
    ('shaving', 'shavings', NULL, 0, 'quantity', NULL),
    ('slice', 'slices', NULL, 0, 'quantity', NULL),
    ('third', 'thirds', NULL, 0, 'miscellaneous',NULL),
    ('twist', 'twists', NULL, 0, 'quantity', NULL),
    ('wedge', 'wedges', NULL, 0, 'quantity', NULL),
    ('cube', 'cubes',  NULL, 0, 'quantity', NULL),
    ('pinch', 'pinches', NULL, 0, 'quantity', NULL),
    ('scoop', 'scoops', NULL, 0, 'quantity', NULL),
    ('sprig', 'sprigs', NULL, 0, 'quantity', NULL),
    ('stalk', 'stalks', NULL, 0, 'quantity', NULL),
    ('bean', 'beans', NULL, 0, 'quantity', NULL)
;