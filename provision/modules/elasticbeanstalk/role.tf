...
resource "aws_iam_role" "main" {
  name = "${var.project_name}-${var.project_environment}-beanstalk-role"
...
resource "aws_iam_policy" "main" {
  ...
  description = "Policy to allow elastic beanstalk to execute"
  policy = data.aws_iam_policy_document.elasticbeanstalk_barbak_app.json
}
...
data "aws_iam_policy_document" "elasticbeanstalk_barbak_app" {
  statement {
    effect = "Allow"
